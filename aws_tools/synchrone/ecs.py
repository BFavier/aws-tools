...
def get_tasks_descriptions(cluster_name: str, task_arns: Iterable[str], chunk_size: int=100) -> AsyncIterable[dict | None]:
    """
...
def get_tasks_statuses(cluster_name: str, task_arns: Iterable[str], chunk_size: int=100) -> AsyncIterable[TASK_STATUSES | None]:
    """
